...
(function(a, M) {
    ...
    a.common.ConnectorStraight.prototype.draw = function(f, b, d, c, e, g, h, i, j, k, l, n, m, p, q) {
        ...
        c.loopEdges(function(a, b) {
            s = a.getIntersectionPoint(v, !0, 1);
            y = b;
            return null != s
        });
        if (null != r && null != s) {
    ...
    a.famdiagram.LabelAnnotationOptionTask = function(f, b, d) {
        var c = [],
            ...
            i = new a.common.ArrayReader(new a.common.ObjectReader({
                zOrderType: new a.common.EnumerationReader(a.common.ZOrderType, !1, d.zOrderType),
    ...
    a.famdiagram.TaskManagerFactory = function(f, b, d, c) {
        ...
        e.addTask("ItemsOptionTask", ["OptionsTask", "defaultItemConfig"], a.famdiagram.ItemsOptionTask, "#000080");
        ...
        e.addTask("NeighboursSelectionModeOptionTask", ["OptionsTask", "defaultConfig"], a.famdiagram.NeighboursSelectionModeOptionTask, "#000080");
        ...
        e.addTask("HighlightItemTask", ["HighlightItemOptionTask", "ActiveItemsTask"], a.orgdiagram.HighlightItemTask, "#00ffff");
        ...
        e.addTask("SelectionPathItemsTask", ["AddLabelAnnotationsTask", "CursorItemTask", "SelectedItemsTask", "CursorSelectionPathModeOptionTask"], a.orgdiagram.SelectionPathItemsTask, "#00ffff");
    ...
    //holicraft96 editar tamaño cuadros
    ...
    a.common.HorizontalConnectorBundle.prototype.trace = function(f, b) {
        ...
        e.actualPosition.x < g.actualPosition.x ? b.transform.transformPoints(e.actualPosition.right(), e.horizontalConnectorsShift, g.actualPosition.x, g.horizontalConnectorsShift, !0, this, function(b, c, d, e) {
            ...
            var e = {},
                ...
                h = new a.common.ObjectReader({
                    ...
                    items: new a.common.ArrayReader(new a.common.ObjectReader({
                        ...
                        hasSelectorCheckbox: new a.common.EnumerationReader(a.common.Enabled, !1, d.hasSelectorCheckbox),
            ...
            h = new a.common.ObjectReader({
                ...
                templates: new a.common.ArrayReader(new a.common.ObjectReader({
                    ...
                    cursorPadding: new a.common.ObjectReader({
                        ...
                        bottom: new a.common.ValueReader(["number"], !1, c.cursorPadding.bottom)
                    }, !1, c.cursorPadding),
                ...
                for (var e in b.treeItemsPositions)
                    if (b.treeItemsPositions.hasOwnProperty(e)) {
                        var f = c.itemsOptions[e],
                            ...
                            m = g.actualPosition;
                        null != f && b.transform.transformRect(m.x, m.y, m.width, m.height, !0, this, function(b, e, h, k) {
                            var m;
    ...
    a.orgdiagram.DrawMinimizedItemsTask = function(f, b, d, c, e, g) {
        function h() {
            var b = new a.common.PolylinesBuffer,
                ...
                g, t, v, u, z, x, B, y, w, A;
            for (A in n) n.hasOwnProperty(A) && (z = n[A], x = z.actualPosition, B = c.getItemOptions(A), j.transformRect(x.x, x.y, x.width, x.height, !0, this, function(c, i, n, j) {
    ...
    a.common.CheckBoxTemplate = function() {
        var b = ["div", ["label", {
                style: {
                    width: "100%"
                }
            ...
            ["div", {
                ...
                ["input",{
                    type: "button",
                    "field-id":"",
                    onclick: "clickInfo(this)",
                    name: "checkbox:",
                    value: "Gestionar",
                    class: "bp-selectioncheckbox btn btn-outline-warning",
                    style:{
                        height:"22px",
                        width:"100%",
                        color:"black",
        ...
        return {
            ...
            render: function(a, b) {
                ...
                e.setAttribute("data-id", b.context.dataId);
    ...
    a.common.ItemTemplate = function(f, b) {
        ...
        d = ["div", {
                style: {
                    ...
                    estilo: "10px !important"
                },
                "class": ["bp-item", "bp-corner-all", "bt-item-frame", "holitoxd"]
            },
            ["div", {
    ...
    a.orgdiagram.TaskManagerFactory = function(f, b, d, c) {
        ...
        e.addDependency("isFamilyChartMode", !1);
        ...
        e.addTask("ButtonsTemplateTask", ["ItemsSizesOptionTask", "templates"], a.orgdiagram.ButtonsTemplateTask, "#00ffff");
        e.addTask("AnnotationLabelTemplateTask", ["ItemsOptionTask"], a.orgdiagram.AnnotationLabelTemplateTask, "#00ffff");
        e.addTask("VisualTreeTask", ["OrgTreeTask", "ActiveItemsTask", "VisualTreeOptionTask", "isFamilyChartMode"], a.orgdiagram.VisualTreeTask, "#ff0000");
    ...
    a.common.family = function(f) {
        ...
        var y = {},
            ...
            F = {},
            C = {};
        a.common.isObject(f) && (y = a.common.cloneObject(f.roots, !1), w = a.common.cloneObject(f.rootsCount, !0), A = a.common.cloneObject(f.children, !1), E = a.common.cloneObject(f.childrenCount, !0), D = a.common.cloneObject(f.parents, !1), F = a.common.cloneObject(f.parentsCount, !0), C = a.common.cloneObject(f.nodes, !0));
        return {
            add: function(a, c, d) {
                var e, f, h = {};
            ...
            validate: function(a) {
                ...
                for (b in i)
                    if (i.hasOwnProperty(b)) {
                        if (!g.hasOwnProperty(b) || !h.hasOwnProperty(b)) return null != a && (a.message = "Orphant key found!"), !1;
    ...
    a.common.tree = function(f) {
        ...
        var g = {},
            ...
            j = {},
            k = {};
        a.common.isObject(f) && (g = a.common.cloneObject(f.nodes, !0), h = a.common.cloneObject(f.parents, !0), i = a.common.cloneObject(f.children, !1), j = a.common.cloneObject(f.roots, !1), k = a.common.cloneObject(f.rootChildren, !0));
        return {
            loop: function(a, b) {
                var c;
                if (null != b)
