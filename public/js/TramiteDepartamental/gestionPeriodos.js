...
function guardarPeriodo(){
    ...
    {
        fecha_inicio: $('#single_cal3').val(),
        fecha_fin: $('#single_cal4').val(),
...
function editarPeriodo(idperiodo) {
    $.get(`/periodo/gestion/${idperiodo}/edit`,function(periodo){
        ...
        $('#single_cal3').val(periodo.fecha_inicio);
        $('#single_cal3').keyup(); // actulizamos la seleciona en el cuadro de fecha de inicio

        //agergamos la fecha final en el input
        $('#single_cal4').val(periodo.fecha_fin);
        $('#single_cal4').keyup(); // actulizamos la seleciona en el cuadro de fecha de fin
...
function cancelarPeriodo(){
    ...
    var fecha_actual=$.datepicker.formatDate('mm/dd/yy', new Date());

    // deseleccionamos las fechas editadas

            //agregamos la fecha de inicio en el input
            $('#single_cal3').val(fecha_actual);
            $('#single_cal3').keyup(); // actulizamos la seleciona en el cuadro de fecha de inicio
    
            //agergamos la fecha final en el input
            $('#single_cal4').val(fecha_actual);
            $('#single_cal4').keyup(); // actulizamos la seleciona en el cuadro de fecha de fin
