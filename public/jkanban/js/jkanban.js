...
var reciduoFlechas = 0; // para almacenar el reciduo de la flecha
  ...
  this.jKanban = function() {
    ...
    this.addBoards = function(boards, isInit) {
      ...
      for (var boardkey in boards) {
        ...
        var ht = document.createTextNode(board.title);
        Hboard.setAttribute(
          "class",
          "kanban-title-board"
        );
        Hboard.appendChild(ht);
        ...
        if (addButton) {
          ...
          headerBoard.appendChild(Hboard);
        ...
        //--------- codigo Holger --------------------------------
            ...
            var numFlechas = parseInt(boardWidth)/18; // 18 el width de las fechas
            reciduoFlechas+=(numFlechas%1);
      
            numFlechas = parseInt(numFlechas); // convertimos (redonadeamos)
            content_flechas = document.getElementById("content_flechas");

            if(reciduoFlechas>=0.3){
              numFlechas+=1;
              reciduoFlechas=0;
            }

            for (let index = 0; index < numFlechas; index++) {
                var spanIcon = document.createElement("span");
                spanIcon.classList.add("glyphicon");
                spanIcon.classList.add("glyphicon-chevron-right");
                spanIcon.classList.add("fa-2x");
                spanIcon.classList.add("flecha_"+board.id);
                spanIcon.setAttribute(
                  "style",
                  "width: 18px; color: #d9d9d9"
                );
                content_flechas.appendChild(spanIcon);              
            }

          //   for (let index = 0; index < numFlechas; index++) {
          //     var divGeneral = document.createElement("div");
          //     divGeneral.classList.add("direccion");

          //     var div1 = document.createElement("div");
          //     div1.classList.add("ribbon");

          //     var div2 = document.createElement("div");
          //     div2.classList.add("triangulo");

          //     divGeneral.appendChild(div1);
          //     divGeneral.appendChild(div2);
      
          //     content_flechas.appendChild(divGeneral);              
          // }
        //-----------------------------------------
