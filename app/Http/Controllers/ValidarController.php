...
class ValidarController extends Controller
{
    function verificarUsuario(){
        ...
        if(!userEsTipo('FP') && !userEsTipo('ADFP')){ 
    ...
    function loginTipoFP(){
        if(auth()->guest()){ // si no hay usuarios logueados no retornamos nada en el menu
            ...
            $validarRoles = usuarioTieneVariosRoles();
            if($validarRoles->status == false){return back();}
            //obtenemos los tipos de usuarios que tiene asignado
            $listatipoFPasignados = $validarRoles->listatipoFPasignados;
