    ...
    <div class="modal fade modal_addTipoDocumento" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Agregar documentos requeridos</h4>
            </div>
            ...
            <!-- Lista de tipo de documentos -->
                <div class="">
                    <div class="x_panel" style="margin-bottom: 0;">
                      ...
                      <div class="x_title">
                        <h2><i class="fa fa-book"></i> Lista <small>Tipos de documentos</small></h2>
                        <div class="clearfix"></div>
                      </div>

                      <div id="lista_tipo_documentos_modal" class="x_content div_scroll_select_doc_act">
                        
                        {{-- cargamos todos los tipo de documentos como ocultos --}}
                        @isset($listaTipoDocumento)
                            <ul class="to_do">
                                @foreach ($listaTipoDocumento as $tipoDocumento)                                    
                                    <li id="{{'li_tipo_doc_'.$tipoDocumento->idtipo_documento}}" class="li_tipo_documento">
                                        <label class="label_doc_act_select" for="{{'tipo_doc_'.$tipoDocumento->idtipo_documento}}">
                                            <input type="checkbox" id="{{'tipo_doc_'.$tipoDocumento->idtipo_documento}}" value="{{$tipoDocumento->idtipo_documento}}" class="flat td_seleccionado"> {{$tipoDocumento->descripcion}}
                                        </label>                                
                                    </li>                                    
                                @endforeach
                            </ul>
