    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-info-2">
            <div class="panel-heading">
                <i class="fa fa-warning"></i> Trámites en revisión
            </div>
            <div class="panel-body">
                ...
                <div id="alerta_info_cabe_pie" class="alert_info_doc" style="display: block;">
                   ...
                   A continuación, se muestran los trámites revisados por el jefe del departamento y que fueron retornados para realizar correcciones. 
                </div>
...
<div id="contet_ver_tramite" style="display: none;">
    ...
    <hr class="hr_line">
        ...
        <a id="btn_revision_corregir" href="" class="btn btn-sm btn-warning btn_regresar"><i class="fa fa-wrench"></i> Corregir</a>
        <form method="POST" action="" enctype="multipart/form-data" style="display: inline;">
            {{csrf_field() }}
            <input type="hidden" name="_method" value="DELETE">  
            <button id="btn_revision_eliminar" style="color: #ffff;" type="button" class="btn btn-sm btn-danger btn_regresar"><i class="fa fa-trash"></i> Eliminar</button>
        </form>
    <hr class="hr_line">
...
<script src="{{asset('js/TramiteDepartamental/bandejas/gestionEnRevision.js')}}"></script>
