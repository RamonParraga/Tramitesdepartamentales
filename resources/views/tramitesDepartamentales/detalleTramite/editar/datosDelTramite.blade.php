                    ...
                    <li class="list-unstyled-li">
                        <div class="block">
                            ...
                            <div id="div_conteDepEnviar">
                                ...
                                @foreach ($listaPara as $destinoPara)
                                    <div class="info_seleccionada_{{$destinoPara->departamento->iddepartamento}} depEnviar_content">                                                                                                                        
                                        <h2 class="title">
                                            <i class="fa fa-cube iconoTittle"></i>
                                            <button type="button" onclick="borrarInformacionSeleccionada(this,{{$destinoPara->departamento->iddepartamento}},'P')" class="btn btn-danger btn-xs depParaInteres_btn_quitar hidden">
                                                <i class="fa fa-remove"></i> Borrar
                                            </button> 
                                            <p>{{$destinoPara->departamento->jefe_departamento[0]->us001->name}}
                                                <span class="labelInfoUser">/</span>
                                                <span class="labelInfoUser"><i class="fa fa-bookmark"></i> {{$destinoPara->departamento->nombre}}</span>
                                            </p>                                            
                                        </h2>       
                                        <input type="hidden" name="input_depaEnviarPara[]" value="{{encrypt($destinoPara->departamento->iddepartamento)}}">
                                    </div>  
                                @endforeach
                    ...
                    <li class="list-unstyled-li">
                        <div class="block">
                            ...
                            <div id="div_conteCopiaEnviar">
                                ...
                                @foreach ($listaCopia as $destinoCopia)
                                    <div class="info_seleccionada_{{$destinoCopia->departamento->iddepartamento}} depEnviar_content">                                                                                                                        
                                        <h2 class="title">
                                            <i class="fa fa-cube iconoTittle"></i>
                                            <button type="button" onclick="borrarInformacionSeleccionada(this,{{$destinoCopia->departamento->iddepartamento}},'C')" class="btn btn-danger btn-xs depParaInteres_btn_quitar hidden">
                                                <i class="fa fa-remove"></i> Borrar
                                            </button> 
                                            <p>{{$destinoCopia->departamento->jefe_departamento[0]->us001->name}}
                                                <span class="labelInfoUser">/</span>
                                                <span class="labelInfoUser"><i class="fa fa-bookmark"></i> {{$destinoCopia->departamento->nombre}}</span>
                                            </p>                                            
                                        </h2>       
                                        <input type="hidden" name="input_depaEnviarCopia[]" value="{{encrypt($destinoCopia->departamento->iddepartamento)}}">
                                    </div>  
                                @endforeach
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12 colpr0">
            <input type="text" name="gt_asunto" id="gt_asunto" value="{{$detalle_tramite->asunto}}" placeholder="Ingrese el asunto del támite" class="date-picker form-control col-md-7 col-xs-12 sinespecial" required="required" style="text-transform: uppercase;">
            <span class="sinespecialMsj"></span>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12 colpr0">
            <textarea type="text" name="gt_observaciones" id="gt_observaciones" placeholder="Ingrese la observación del trámite" rows="3" class="date-picker form-control col-md-7 col-xs-12 sinespecial" required="required" style="text-transform: uppercase;">{{$detalle_tramite->observacion}}</textarea>
            <span class="sinespecialMsj"></span>            
        </div>
    </div>
