...
<html lang="en">
  <head>
    ...
    <title>Trámites Departamentales</title>
        ...
        <div class="animate form login_form animate-margin-mobil">
          <section class="login_content contenedorSelecTipoFP">
             ...
             <form class="form-horizontal" method="POST" action="{{ route('login') }}">
              ...
              <div style="display: inline-table; padding-bottom: 20px;">{!! Recaptcha::render() !!}</div>
              <div id="contenedorredca">
              <?php 
              ...
              @if ($errors->has('g-recaptcha-response'))
                  <span class="help-block" style="color: #A70E03; margin-top: 0px; margin-bottom: 20px;"> <strong>Verifique que no es un robot</strong></span>
              @endif
              ...
              <div class="separator">
                ...
                <div>
                  <i class="fa fa-file-text-o" style="font-size: 20px; margin-right: 5px;"></i> Trámites Departamentales Chone
